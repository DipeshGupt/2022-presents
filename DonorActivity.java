        ...
        submit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(texteditname1)){
                    Toast.makeText(DonorActivity.this,"please enter your name",Toast.LENGTH_LONG).show();
                    editname.setError("name is required");
                    editname.requestFocus();
                } else if (TextUtils.isEmpty(texteditname2)) {
                    Toast.makeText(DonorActivity.this,"please enter your gender",Toast.LENGTH_LONG).show();
                    editname1.setError("gender is required");
                    editname1.requestFocus();

                } else if (TextUtils.isEmpty(texteditname3)) {
                    Toast.makeText(DonorActivity.this,"please enter your email",Toast.LENGTH_LONG).show();
                    editname2.setError("Email is required");
                    editname2.requestFocus();
                }else if (!Patterns.EMAIL_ADDRESS.matcher(texteditname3).matches()) {
                    Toast.makeText(DonorActivity.this,"please re-enter your email",Toast.LENGTH_LONG).show();
                    editname2.setError("Valid Email is required");
                    editname2.requestFocus();
                } else if (TextUtils.isEmpty(texteditname4)) {
                    Toast.makeText(DonorActivity.this,"please enter your blood type",Toast.LENGTH_LONG).show();
                    editname3.setError("Date of birth is required");
                    editname3.requestFocus();

                } else if (TextUtils.isEmpty(texteditname5)) {
                    Toast.makeText(DonorActivity.this,"please enter your address",Toast.LENGTH_LONG).show();
                    editname4.setError("password is required");
                    editname4.requestFocus();

                } else {
                    //progressbar.setVisibility(View.VISIBLE);
                    Toast.makeText(DonorActivity.this,"Your response is recorded",Toast.LENGTH_LONG).show();
